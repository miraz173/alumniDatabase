 ...
 export default function ProfileEdit(){
    ...
    return (
        ...
        <div className="space-y-12">
            ...
            <p className="mt-1 text-sm leading-6 text-blue-600">The information will be publicly visible.</p>
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                {/* <div className="sm:col-span-1">
                    ...
                    <div className="mt-2 text-center">
                        ...
                        type="number"
                        autoComplete="Roll"
                        className="block indent-3 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                        />
                    </div>
                </div>
                ...
                <div className="mt-2">
                    ...
                    placeholder="Comma Separeted: Web Dev, MERN, CyberSecurity Enthusiast, MIT, ICPC World finalist, PRAN-RFL, etc."
                    className="block indent-2 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    />
                </div>
                </div>
                ...
                <label htmlFor="othersocial" className="block text-sm font-medium leading-6 text-gray-900">
                    Other social media links (Sitename space URL_of_Your_Profile)
                </label>
                <div className="mt-2">
                    <textarea
                    type="text"
                    name="othersocial"
                    id="othersocial"
                    autoComplete="othersocial"
                    placeholder="Comma separeted: dribble https://dribble.com/eftekher420, whatsapp http://whatsapp.com/jt7yt5fvvy63, twitter twitter.com/myMizan"
                    className="block indent-2 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    />
                </div>
                </div>
...
{/*
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div className="mt-2 flex items-center gap-x-3">
                    <button className="h-12 w-12 text-gray-300" aria-hidden="true" ></button>
                    <button
                    type="button"
                ...
                <div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                    ...
                    <button className="mx-auto h-12 w-12 text-gray-300" aria-hidden="true" ></button>
                    <div className="mt-4 flex text-sm leading-6 text-gray-600">
                        <label
                        htmlFor="file-upload"
                        className="relative cursor-pointer rounded-md bg-white font-semibold text-indigo-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 hover:text-indigo-500"
